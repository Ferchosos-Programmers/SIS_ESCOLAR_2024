 ...
 <footer class="main-footer">
   ...
   <!-- Default to the left -->
   <strong>Copyright &copy; <?= $anio_actual ?> <a href="https://github.com/Ferchosos-Programmers" target="_blank">Fernando Mallitaxi</a>.</strong> Reservados todos los derechos.
 </footer>
 </div>
 <!-- ./wrapper -->
 ...
 <!-- REQUIRED SCRIPTS -->
 <!-- sweetalert2 -->
 <script src="https://cdn.jsdelivr.net/npm/sweetalert2@10/sweetalert2.min.js"></script>
 <!-- jQuery -->
